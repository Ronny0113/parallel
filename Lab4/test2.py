...
def simulated_annealing(b, matrix, n, num_iterations=2000, max_time=600):
...
if __name__ == '__main__':
    print("Запуск поиска минимума на 10 минут...")
    best_config, best_E = simulated_annealing(b, matrix, n, max_time=600)
